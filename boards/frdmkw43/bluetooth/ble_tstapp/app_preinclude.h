...
/* Enable the GAP command platform error callback registration */
#define gEnableGapCmdErr_d              1
...
#define gMaxServicesCount_d             0xFEU

/* Max Characteristics - update according to the usecase */
#define gMaxServiceCharCount_d          0xFEU

/* Max Descriptors - update according to the usecase */
#define gMaxCharDescriptorsCount_d      0xFEU

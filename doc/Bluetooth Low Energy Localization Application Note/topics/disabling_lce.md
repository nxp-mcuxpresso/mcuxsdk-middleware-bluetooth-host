...
1. Open <SDK>/examples/_boards/<board>/wireless_examples/bluetooth/<example_name>/prj.conf:
 - replace CONFIG_MCUX_COMPONENT_middleware.wireless.rade2_algo_cm33_lce_lib=y with CONFIG_MCUX_COMPONENT_middleware.wireless.rade1_algo_cm33_lib=y.
...
2. Running the RADE algorithm without LCE support increases stack size requirements. Ensure the stack size for the task on which the algorithm runs is at least 3300 octets.

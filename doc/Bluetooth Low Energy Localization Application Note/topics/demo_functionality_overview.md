...
-   **GAP role**: Set the GAP role using `gAppIsPeripheral_d`, 1 for peripheral role, 0 for central role. In the default configuration, the `loc_reader` application is peripheral.

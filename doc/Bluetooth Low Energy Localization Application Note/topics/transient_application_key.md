...
## Prerequisites
Ensure both applications are compiled with TAK enabled (`gAppUseTAK_d = 1`) and `gAppTAKAdvID_c` matches on both sides. The default configuration supports up to 4 TAK entries (`gConnTakMaxEntries_c = 4`).<br>

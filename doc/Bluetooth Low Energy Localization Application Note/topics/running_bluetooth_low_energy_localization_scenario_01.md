...
-   To trigger a new distance measurement with peer device id `0`, enter “`tdm 0`” on the Localization User Device as shown in [Figure 4](../images/Figure5_Localization_User_Device_TriggerDistMeasurement.png).

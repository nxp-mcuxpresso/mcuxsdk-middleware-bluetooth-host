...
The [Figure 1](#FIG_IG2_KDB_JLB) shows the application folder structure for the *digital\_key\_car\_anchor* project.
...
|![](../images/projectstructure_2021.png "Application folder structure in workspace")

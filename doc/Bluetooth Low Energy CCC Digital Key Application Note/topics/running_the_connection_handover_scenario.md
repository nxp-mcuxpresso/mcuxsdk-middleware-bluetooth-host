...
-   The connection can continue to be handed over back and forth between the two Car Anchors by pressing the **SW3** switch on the Car Anchor which currently has the connection. [Figure 2](../images/handover_s1.png) shows first Car Anchor connects and pairs with the Device, sends the L2CAP test message and successfully performs handover when **SW3** is pressed.

**Paring and connection of First Car Anchor with Device and handover**

![Figure 2](../images/handover_s1.png "Paring and connection of First Car Anchor with Device and handover")

[Figure 3](../images/handover_s2.png) shows that the second Car Anchor receives the bonding data automatically via UART when the first Car Anchor pairs with the Device. After the handover is successfully completed, it sends the L2CAP test message to the Device.

**Second Car Anchor receiving the bonding data automatically via UART when the first Car Anchor pairs with the Device**

![Figure 3](../images/handover_s2.png "Second Car Anchor receiving the bonding data automatically via UART when the first Car Anchor pairs with the Device")

[Figure 4](../images/handover_dev.png) shows the Device receiving both L2CAP test messages. From the device's point of view, it is in a single uninterrupted connection.

**The Device receives both L2CAP test messages**

![Figure 4](../images/handover_dev.png "The Device receives both L2CAP test messages ")

...
-   After bidirectional communication is established via GATT, the ANCS/AMS Client starts displaying ANCS Notifications information as shown in [Figure 3](#fig8wegew) below. The combination of the two services \(ANCS and AMS\) is shown in [Figure 4](#fig_834d3a34-8e67-4b83-ac45-42beeffeff5e) and [Figure 5](#fig_1e62afa3-8bcd-4fed-9dea-ccdcdf01510f). If no media is playing and no player is active, the serial interface looks as shown in [Figure 4](#fig_834d3a34-8e67-4b83-ac45-42beeffeff5e). When media is playing, a player is active and the state must look similar to [Figure 5](#fig_1e62afa3-8bcd-4fed-9dea-ccdcdf01510f).

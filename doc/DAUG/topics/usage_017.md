...
1.  Open a serial port terminal and connect it to each platform with the settings provided in the previous paragraph. The start screen is displayed after the boards are reset as shown in [Figure 1](#253dfh) and [Figure 2](#232553dfh).

    ![](../images/adv_ext_peripheral_start_screen.png "adv_ext_peripheral start screen")

    ![](../images/adv_ext_central_start_screen.png "adv_ext_central start screen")

2.  On the board that implements the adv\_ext\_peripheral application, press the **WAKESW** button. The board exits Deep-sleep mode and displays the menu as shown in [Figure 3](#0865253dfh).

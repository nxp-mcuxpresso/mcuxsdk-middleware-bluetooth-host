...
To demonstrate the profile functionality, most of the scenarios require one of the supported platforms and a Bluetooth Low Energy capable central device. The device is usually a smartphone or a tablet that runs a compatible Bluetooth LE application. [Figure 1](#BLEDAUG0003) shows the **IoT Toolbox** UI.
...
To provide feedback and more interaction, some examples use a shell console via the virtual COM port. To access the device, open a serial port terminal and as shown in the [Figure 2](#BLEDAUG1000). For this example, Tera Term VT and a KW45B41Z-EVK or K32W148-EVK, or a FRDM-MCXW71 board can be used. The communication parameters are 115200 and 8N1.

![](../images/tera_term_jlink_serial_port.png "Tera Term – mbed serial port")

Connect it to the platform with parameters as shown in [Figure 3](#BLEDAUG1001).

![](../images/tera_term_jlink_serial_port_config.png "Tera Term – mbed serial port configuration")

The start screen is displayed after the board is reset as shown in [Figure 4](#fig4).

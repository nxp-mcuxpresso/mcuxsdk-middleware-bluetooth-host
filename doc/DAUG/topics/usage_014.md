...
To make the HID mouse visible, press the **ADVSW** button to start sending advertisements, which causes CONNLED to start flashing. See the figure **Enter PIN prompt on Android platform** below.<br>
![Enter PIN prompt on Android platform](../images/enter_pin_prompt_on_android_platform.png "Enter PIN prompt on Android platform")<br>

...
This section describes the advanced security capabilities of the Bluetooth LE Host Stack which are available on the KW45/KW47/MCXW72/FRDM-KW43 platform via the EdgeLock Secure Enclave \(ELKE\).

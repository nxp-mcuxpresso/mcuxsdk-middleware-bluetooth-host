...
First, 'BLE_SHELL_TAK_SUPPORT' must be enabled and 'BLE_SHELL_MAX_TAK_ENTRIES' must be configured to the maximum number of keys we want to support on a device. Also 'gBleHostAutoRejectLtkRequestForUnbondedDevices_c' must be set to FALSE.

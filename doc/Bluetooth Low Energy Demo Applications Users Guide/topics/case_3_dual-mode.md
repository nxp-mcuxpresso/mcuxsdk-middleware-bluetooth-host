...
3.  Start typing in either of the terminals. As seen in [Figure](../images/Fig56.png), the Bluetooth LE activity is prioritized. In this step, characters are printed in the peer’s terminal and Generic FSK continues in the available slots, not used by the Bluetooth LE link.

    **Teraterm – Mixed Wireless UART (Bluetooth LE) and Generic FSK activity**
    ![](../images/Fig56.png "Teraterm – Mixed Wireless UART (Bluetooth LE) and Generic FSK activity")

...
To enable Periodic Advertising With Responses (PAWR), set the gAppPAWRSupport_d define 1 in app_preinclude.h.
...
To enable Encrypted Advertising Data (EAD), set the gAppEADSupport_d define 1 in app_preinclude.h.

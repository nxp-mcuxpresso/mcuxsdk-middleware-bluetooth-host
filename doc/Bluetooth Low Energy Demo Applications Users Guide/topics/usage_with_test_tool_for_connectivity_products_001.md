...
3.  Open the Test Tool application and connect to the serial port corresponding to the board on which the Bluetooth LE FSCI Black Box application runs. See [Figure](../images/image_25_1.png). The serial communication parameters are: baud rate 115200, 8N1, and no flow control.

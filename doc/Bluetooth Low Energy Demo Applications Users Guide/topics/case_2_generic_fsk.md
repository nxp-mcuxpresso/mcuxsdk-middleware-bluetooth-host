...
1.  Open a serial port terminal and connect to the two boards, in the same manner described in [Testing devices](testing_devices.md). The start screen after the board is reset is the same as in [Figure](../images/Fig52.png).
...
3.  To start transmitting, long press the **ROLESW** button on the other board. The transmitting device uses an identifier known by the receiver and its packets are displayed in the CLI as shown in [Figure](../images/Fig54.png):
...
5.  To stop the periodic Generic FSK transmit operation, long press the **ROLESW** button again, if the transmit procedure is ongoing. The long press of the **ROLESW** button acts as a toggle for the transmit. At this point, both devices can reverse the direction of communication by following the exact same steps.
    ...
    See [Figure](../images/Fig55.png).

    **Tera Term – stop Generic FSK activity**
    ![](../images/Fig55.png "Tera Term – stop Generic FSK activity")

...
The IRK defined by *aOwnIrk* is used by the Controller to periodically generate a new Resolvable Private Address \(RPA\). The lifetime of the RPA is a number of seconds contained by the *gGapControllerPrivacyTimeout*external constant, which is defined in the *ble\_config.c* source file. The default value for this is 900 \(15 minutes\).

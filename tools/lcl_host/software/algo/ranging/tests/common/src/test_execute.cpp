...
extern int test_runner_functions();
extern int test_runner_matrix();
extern int test_runner_ranging_config();
...
int test_execute(void) {
	...
	ret += test_runner_functions();
	EXIT_ON_ERROR();

	ret += test_runner_matrix();
	EXIT_ON_ERROR();

	ret += test_runner_ranging_config();
	EXIT_ON_ERROR();

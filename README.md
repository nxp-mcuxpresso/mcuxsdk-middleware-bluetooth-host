...
Visit [Bluetooth LE host - Documentation](https://mcuxpresso.nxp.com/mcuxsdk/latest/html/middleware/wireless/bluetooth/index.html) to review details on the contents in this sub-repo.  

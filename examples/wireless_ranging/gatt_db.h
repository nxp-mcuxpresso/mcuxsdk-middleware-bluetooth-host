...
PRIMARY_SERVICE_UUID128(service_wireless_ranging, uuid_service_wireless_ranging)
    CHARACTERISTIC_UUID128(char_wr_ctrl_stream, uuid_wr_control_stream, (gGattCharPropWriteWithoutRsp_c))
        VALUE_UUID128_VARLEN(value_wr_ctrl_stream, uuid_wr_control_stream, (gPermissionFlagWritable_c), gAttMaxWriteDataSize_d(gAttMaxMtu_c), 1, 0x00)

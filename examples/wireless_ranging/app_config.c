...
gapAdvertisingParameters_t gAdvParams = {
    ...
    /* maxInterval */         gGapAdvertisingIntervalRangeMinimum_c + 0x10,
...
static const gapAdStructure_t advScanStruct[3] = {
  ...
  {
    .length = NumberOfElements(uuid_service_wireless_ranging) + 1,
    .adType = gAdComplete128bitServiceList_c,
    .aData = (uint8_t *)uuid_service_wireless_ranging
  },
  {
    .adType = gAdShortenedLocalName_c,
    .length = 7,
    .aData = (uint8_t*)"NXP_WR"
  }
};
...
gapConnectionRequestParameters_t gConnReqParams =
{
    ...
    .ownAddressType = gBleAddrTypePublic_c,
    .connIntervalMin = 6, /* [1.25ms] - value changed dynamically by the app */
    .connIntervalMax = 25, /* [1.25ms]  - value changed dynamically by the app */
    .connLatency = 0,
    .supervisionTimeout = 0x20, /* [10ms] NOTE: there is a dependency between connEventLengthMax and supervisionTimeout (if the condition fails gHciInvalidHciCommandParameters_c errors occur) */
...
static const gapSecurityRequirements_t  deviceSecurity = {

...
static uint8_t adData0[19] =  { UuidArray(gBleSig_TirePressureMonitoringService_d), /*! TMPS UUID */
                               0x00, 0x00,                                          /*! Tire Pressure */
                               0x00,                                                /*! Tire Pressure Accuracy */
                               0x00,                                                /*! Tire Temperature */
                               (BIT3),                                              /*! Indicators: BIT3 (Bondable) */
                               0x11, 0x01,                                          /*! Option - Temperature Accuracy, code 1, length 1 */
                               0x12, 0x01,                                          /*! Option - Position, code 2, length 1, initial value Front Center */
                               0x00, 0x00, 0x00, 0x00,                              /*! Sequence Number */
                               0x00, 0x00, 0x00, 0x00                               /*! MAC */
                               };

static uint8_t adData1[1] =  { (gapAdTypeFlags_t)(gLeLimitedDiscoverableMode_c | gBrEdrNotSupported_c) };
...
#else
    .centralKeys = (gapSmpKeyFlags_t) (gNoKeys_c),
    .peripheralKeys = (gapSmpKeyFlags_t) (gNoKeys_c),
#endif
...
static gapServiceSecurityRequirements_t serviceSecurity[3] = {
  {
    ...
    .serviceHandle = (uint16_t)service_tpms
  },
  {
    .requirements = {
        .securityModeLevel = gSecurityMode_1_Level_3_c,

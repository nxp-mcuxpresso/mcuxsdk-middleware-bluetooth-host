...
PRIMARY_SERVICE(service_dk, gBleSig_CCC_DK_UUID_d)
    ...
    CHARACTERISTIC_UUID128(char_device_selected_dk_version, uuid_char_device_selected_dk_version, (gGattCharPropWrite_c) )
            VALUE_UUID128(value_device_selected_dk_version, uuid_char_device_selected_dk_version, (gPermissionFlagWritable_c | gPermissionFlagWriteWithEncryption_c | gPermissionFlagWriteWithAuthentication_c), 4, 0x00, 0x00, 0x00, 0x00)

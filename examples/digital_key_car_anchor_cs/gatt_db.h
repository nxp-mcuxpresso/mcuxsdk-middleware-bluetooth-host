...
CHARACTERISTIC_UUID128(char_vehicle_psm_vdbt_version, uuid_char_vehicle_psm_vdbt_version, (gGattCharPropRead_c) )
            VALUE_UUID128(value_vehicle_psm_vdbt_version, uuid_char_vehicle_psm_vdbt_version, (gPermissionFlagReadable_c | gPermissionFlagReadWithEncryption_c | gPermissionFlagReadWithAuthentication_c), 7, MSB2(gDK_DefaultVehiclePsm_c), LSB2(gDK_DefaultVehiclePsm_c), 2, 0x03, 0x00, 1, 0xFF)

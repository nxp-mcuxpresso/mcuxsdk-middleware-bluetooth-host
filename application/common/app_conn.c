...
/* convert 32Khz ticks into milliseconds */
#define CONVERT_MS_2_32Kticks(time_ms)    ((time_ms * 32768) / 1000 )
...
)
{
        ...
        (void)Controller_SetSleepClockAccuracy(BOARD_32KHZ_SRC_CLK_ACCURACY);
#endif

...
{
    NULL,                                                                             /* reserved: 0x00 */
    NULL,                                              /* = 0x01, gBleGapCmdBleHostInitializeOpCode_c */
    NULL,                             /* = 0x02, gBleGapCmdRegisterDeviceSecurityRequirementsOpCode_c */
    ...
    NULL,                                                      /* = 0x07, gBleGapCmdAuthorizeOpCode_c */
    NULL,                                                       /* = 0x08, gBleGapCmdSaveCccdOpCode_c */
    NULL,                                        /* = 0x09, gBleGapCmdCheckNotificationStatusOpCode_c */
    NULL,                                          /* = 0x0A, gBleGapCmdCheckIndicationStatusOpCode_c */
    NULL,                                                                             /* reserved: 0x0B */
    NULL,                                                           /* = 0x0C, gBleGapCmdPairOpCode_c */
    NULL,                                  /* = 0x0D, gBleGapCmdSendPeripheralSecurityRequestOpCode_c */
    NULL,                                                    /* = 0x0E, gBleGapCmdEncryptLinkOpCode_c */
    NULL,                                           /* = 0x0F, gBleGapCmdAcceptPairingRequestOpCode_c */
    HandleGapCmdRejectPairingOpCode,                                                  /* = 0x10, gBleGapCmdRejectPairingOpCode_c */
    NULL,                                                   /* = 0x11, gBleGapCmdEnterPasskeyOpCode_c */
    NULL,                                                     /* = 0x12, gBleGapCmdProvideOobOpCode_c */
    NULL,                                           /* = 0x13, gBleGapCmdRejectPasskeyRequestOpCode_c */
    NULL,                                                    /* = 0x14, gBleGapCmdSendSmpKeysOpCode_c */
    NULL,                                       /* = 0x15, gBleGapCmdRejectKeyExchangeRequestOpCode_c */
    NULL,                                             /* = 0x16, gBleGapCmdProvideLongTermKeyOpCode_c */
    NULL,                                                /* = 0x17, gBleGapCmdDenyLongTermKeyOpCode_c */
    NULL,                                      /* = 0x18, gBleGapCmdLoadEncryptionInformationOpCode_c */
    NULL,                                                /* = 0x19, gBleGapCmdSetLocalPasskeyOpCode_c */
    NULL,                                                  /* = 0x1A, gBleGapCmdStartScanningOpCode_c */
    NULL,                                                   /* = 0x1B, gBleGapCmdStopScanningOpCode_c */
    NULL,                                                        /* = 0x1C, gBleGapCmdConnectOpCode_c */
    HandleGapCmdDisconnectOpCode,                                                     /* = 0x1D, gBleGapCmdDisconnectOpCode_c */
    NULL,                                      /* = 0x1E, gBleGapCmdSaveCustomPeerInformationOpCode_c */
    NULL,                                      /* = 0x1F, gBleGapCmdLoadCustomPeerInformationOpCode_c */
    NULL,                                                  /* = 0x20, gBleGapCmdCheckIfBondedOpCode_c */
    NULL,                                       /* = 0x21, gBleGapCmdReadFilterAcceptListSizeOpCode_c */
    NULL,                                          /* = 0x22, gBleGapCmdClearFilterAcceptListOpCode_c */
    NULL,                                    /* = 0x23, gBleGapCmdAddDeviceToFilterAcceptListOpCode_c */
    NULL,                               /* = 0x24, gBleGapCmdRemoveDeviceFromFilterAcceptListOpCode_c */
    NULL,                                        /* = 0x25, gBleGapCmdReadPublicDeviceAddressOpCode_c */
    NULL,                                      /* = 0x26, gBleGapCmdCreateRandomDeviceAddressOpCode_c */
    NULL,                                                 /* = 0x27, gBleGapCmdSaveDeviceNameOpCode_c */
    NULL,                                          /* = 0x28, gBleGapCmdGetBondedDevicesCountOpCode_c */
    NULL,                                            /* = 0x29, gBleGapCmdGetBondedDeviceNameOpCode_c */
    NULL,                                                     /* = 0x2A, gBleGapCmdRemoveBondOpCode_c */
    NULL,                                                 /* = 0x2B, gBleGapCmdRemoveAllBondsOpCode_c */
    NULL,                                            /* = 0x2C, gBleGapCmdReadRadioPowerLevelOpCode_c */
    NULL,                                 /* = 0x2D, gBleGapCmdVerifyPrivateResolvableAddressOpCode_c */
    NULL,                                               /* = 0x2E, gBleGapCmdSetRandomAddressOpCode_c */
    NULL,                                                    /* = 0x2F, gBleGapCmdSetScanModeOpCode_c */
    NULL,                                          /* = 0x30, gBleGapCmdSetDefaultPairingParameters_c */
    NULL,                                     /* = 0x31, gBleGapCmdUpdateConnectionParametersOpCode_c */
    NULL,                               /* = 0x32, gBleGapCmdEnableUpdateConnectionParametersOpCode_c */
    NULL,                                             /* = 0x33, gBleGapCmdUpdateLeDataLengthOpCode_c */
    NULL,                                                                             /* reserved: 0x34 */
    NULL,                                              /* = 0x35, gBleGapCmdEnableHostPrivacyOpCode_c */
    NULL,                                        /* = 0x36, gBleGapCmdEnableControllerPrivacyOpCode_c */
    NULL,                                        /* = 0x37, gBleGapCmdLeScRegeneratePublicKeyOpCode_c */
    NULL,                                       /* = 0x38, gBleGapCmdLeScValidateNumericValueOpCode_c */
    NULL,                                            /* = 0x39, gBleGapCmdLeScGetLocalOobDataOpCode_c */
    NULL,                                             /* = 0x3A, gBleGapCmdLeScSetPeerOobDataOpCode_c */
    NULL,                            /* = 0x3B, gBleGapCmdLeScSendKeypressNotificationPrivacyOpCode_c */
    NULL,                            /* = 0x3C, gBleGapCmdGetBondedDevicesIdentityInformationOpCode_c */
    HandleGapCmdSetTxPowerLevelOpCode,                                                /* = 0x3D, gBleGapCmdSetTxPowerLevelOpCode_c */
    NULL,                                                      /* = 0x3E, gBleGapCmdLeReadPhyOpCode_c */
    HandleGapCmdLeSetPhyOpCode,                                                       /* = 0x3F, gBleGapCmdLeSetPhyOpCode_c */
    NULL,                                         /* = 0x40, gBleGapCmdControllerNotificationOpCode_c */
    NULL,                                                       /* = 0x41, gBleGapCmdLoadKeysOpCode_c */
    NULL,                                                       /* = 0x42, gBleGapCmdSaveKeysOpCode_c */
    NULL,                                                  /* = 0x43, gBleGapCmdSetChannelMapOpCode_c */
    NULL,                                                 /* = 0x44, gBleGapCmdReadChannelMapOpCode_c */
    NULL,                                                 /* = 0x45, gBleGapCmdSetPrivacyModeOpCode_c */
    NULL,                                                                             /* reserved: 0x46 */
    NULL,                                         /* = 0x47, gBleGapCmdReadControllerLocalRPAOpCode_c */
    NULL,                                         /* = 0x48, gBleCtrlWritePublicDeviceAddressOpCode_c */
    NULL,                                                  /* = 0x49, gBleGapCmdCheckNvmIndexOpCode_c */
    NULL,                                      /* = 0x4A, gBleGapCmdGetDeviceIdFromConnHandleOpCode_c */
    NULL,                                /* = 0x4B, gBleGapCmdGetConnectionHandleFromDeviceIdOpCode_c */
    NULL,                                                 /* = 0x4C, gBleGapCmdAdvIndexChangeOpCode_c */
    NULL,                                                 /* = 0x4D, gBleGapCmdGetHostVersionOpCode_c */
    NULL,                                       /* = 0x4E, gBleGapCmdGetReadRemoteVersionInfoOpCode_c */
    NULL,                                                  /* = 0x4F, gBleGapCmdGetConnParamsOpCode_c */
    NULL,                                                                             /* reserved: 0x50 */
    NULL,                                                                             /* reserved: 0x51 */
    NULL,                                                                             /* reserved: 0x52 */
    NULL,                                                                             /* reserved: 0x53 */
    ...
    NULL,                                                                             /* reserved: 0x70 */
    NULL,                                                                             /* reserved: 0x71 */
    NULL,                                          /* = 0x72, gBleGapCmdEattConnectionRequestOpCode_c */
    NULL,                                           /* = 0x73, gBleGapCmdEattConnectionAcceptOpCode_c */
    NULL,                                         /* = 0x74, gBleGapCmdEattReconfigureRequestOpCode_c */
    NULL,                                         /* = 0x75, gBleGapCmdEattSendCreditsRequestOpCode_c */ 
    NULL,                                          /* = 0x76, gBleGapCmdEattDisconnectRequestOpCode_c */ 
    NULL,                                       /* = 0x77, gBleCtrlCmdSetConnNotificationModeOpCode_c*/
    NULL,                                                                             /* reserved: 0x78 */
    NULL,                                               /* = 0x79, gBleGapCmdLeSetSchedulerPriority_c */
    NULL,                                                                             /* reserved: 0x7A - gBleCtrlCmdSetMDBitModeOpCode_c on KW38 */
    NULL,                                                     /* = 0x7B, gBleGapCmdLeSetHostFeature_c */
    NULL,                                                                              /* reserved: 0x7C */
    NULL,                                                                             /* reserved: 0x7D */
    NULL,                                                                             /* reserved: 0x7E */
};
...
)
{
    ...
    fsciBleGetBufferFromUint8Value(pGenericEvent->eventData.perAdvSyncTransferReceived.numSubevents, *ppBuffer);
    fsciBleGetBufferFromUint8Value(pGenericEvent->eventData.perAdvSyncTransferReceived.subeventInterval, *ppBuffer);
    fsciBleGetBufferFromUint8Value(pGenericEvent->eventData.perAdvSyncTransferReceived.responseSlotDelay, *ppBuffer);
    fsciBleGetBufferFromUint8Value(pGenericEvent->eventData.perAdvSyncTransferReceived.responseSlotSpacing, *ppBuffer);
}
...
{
    fsciBleGapStatusMonitor(gBleFeatureNotSupported_c);
}

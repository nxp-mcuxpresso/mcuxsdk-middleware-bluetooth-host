    ...
    switch (pGenericEvent->eventType)
    {
        ...
        case gHandoverAnchorMonitorPacketEvent_c:
        {
            ...
            if (checkMonitorFilterCounter(pAnchMntPktEvt->connectionHandle))
            {
                ...
                /* Send data to remote anchor */
                notifyRemoteDevice(gHandoverPacketMonitorCommandOpCode_c, (18U + buf[17]), buf);
            }
            ...
            {
                /* Anchor monitor complete */
                anchorMonitorStop(pAnchMntPktEvt->connectionHandle);
            }
        ...
        case gHandoverAnchorMonitorPacketContinueEvent_c:
        {
            ...
            /* Send data to remote anchor */
            notifyRemoteDevice(gHandoverPacketContinueMonitorCommandOpCode_c, (4U + buf[3]), buf);
        }
        break;
        ...
        case gHandoverGetComplete_c:
        {
            ...
            {
                notifyRemoteDevice(gHandoverDataCommandOpCode_c, mHandoverDataSize, (uint8_t *)mpHandoverData);
            ...
            if (result == gBleSuccess_c)
            {
                ...
                if (mAppHandoverState == gAnchorMonitorRemoteStarting_c)
                {
                    ...
                    if (result == gBleSuccess_c)
                    {
                        ...
                        buf[48] = maAppMonitorData[deviceId].monitorMode;

...
#define fsciBleGapGetPeriodicScannedDeviceV2BufferSize(pScannedDevice)             \
        (sizeof(uint16_t) + sizeof(int8_t) + sizeof(int8_t) + \
...
void fsciBleGapGetConnectionRequestParametersV2FromBuffer
(
    gapConnectionFromPawrParameters_t*  pConnectionRequestFromPawrParameters,
    uint8_t**                           ppBuffer
);

void fsciBleGapGetBuffFromConnReqParametersV2
(
    const gapConnectionFromPawrParameters_t*  pConnectionRequestParameters,
    uint8_t**                           ppBuffer
);
...
void fsciBleGapGetBufferFromPerScannedDeviceV2
(
    gapPeriodicScannedDeviceV2_t* pScannedDevice,
    uint8_t**                     ppBuffer
);

               ...
               case gCSTestEndEvtOpCode_c:
                    {
                        ...
                        /* Copy data from buffer */
                        fsciBleGetEnumValueFromBuffer(metaEvent.eventData.csTestEndEvent.status, pBuffer, bleResult_t);
                        /* Trigger application callback */
                        pCsMetaEventCallback(&metaEvent);
                    }
                    break;
...
)
{
    ...
    fsciBleGetBufferFromUint8Value(pEvent->csSyncPhy, pBuffer);
...
)
{
    ...
    fsciBleGetUint8ValueFromBuffer(pCreateConfigParams->csSyncPhy, *ppBuffer);
...
)
{
    ...
    fsciBleGetUint8ValueFromBuffer(pEvent->csSyncPhy, *ppBuffer);

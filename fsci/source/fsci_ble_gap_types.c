...
void fsciBleGapGetConnectionRequestParametersV2FromBuffer(gapConnectionFromPawrParameters_t* pConnectionRequestParameters, uint8_t** ppBuffer)
{
    /* Read gapConnectionFromPawrParameters_t fields from buffer */
    fsciBleGetUint16ValueFromBuffer(pConnectionRequestParameters->scanInterval, *ppBuffer);
    fsciBleGetUint16ValueFromBuffer(pConnectionRequestParameters->scanWindow, *ppBuffer);
    fsciBleGetEnumValueFromBuffer(pConnectionRequestParameters->filterPolicy, *ppBuffer, bleInitiatorFilterPolicy_t);
    fsciBleGetEnumValueFromBuffer(pConnectionRequestParameters->ownAddressType, *ppBuffer, bleAddressType_t);
    ...
    fsciBleGetBoolValueFromBuffer(pConnectionRequestParameters->usePeerIdentityAddress, *ppBuffer);
    fsciBleGetEnumValueFromBuffer(pConnectionRequestParameters->initiatingPHYs, *ppBuffer, gapLePhyFlags_t);
    fsciBleGetUint8ValueFromBuffer(pConnectionRequestParameters->advHandle, *ppBuffer);
    fsciBleGetUint8ValueFromBuffer(pConnectionRequestParameters->subevent, *ppBuffer);
}

void fsciBleGapGetBuffFromConnReqParametersV2(const gapConnectionFromPawrParameters_t* pConnectionRequestFromPawrParameters, uint8_t** ppBuffer)
{
    /* Write gapConnectionFromPawrParameters_t fields in buffer */
    fsciBleGetBufferFromUint16Value(pConnectionRequestFromPawrParameters->scanInterval, *ppBuffer);
    fsciBleGetBufferFromUint16Value(pConnectionRequestFromPawrParameters->scanWindow, *ppBuffer);
    fsciBleGetBufferFromEnumValue(pConnectionRequestFromPawrParameters->filterPolicy, *ppBuffer, bleInitiatorFilterPolicy_t);
    fsciBleGetBufferFromEnumValue(pConnectionRequestFromPawrParameters->ownAddressType, *ppBuffer, bleAddressType_t);
    fsciBleGetBufferFromEnumValue(pConnectionRequestFromPawrParameters->peerAddressType, *ppBuffer, bleAddressType_t);
    fsciBleGetBufferFromAddress(pConnectionRequestFromPawrParameters->peerAddress, *ppBuffer);
    fsciBleGetBufferFromUint16Value(pConnectionRequestFromPawrParameters->connIntervalMin, *ppBuffer);
    fsciBleGetBufferFromUint16Value(pConnectionRequestFromPawrParameters->connIntervalMax, *ppBuffer);
    fsciBleGetBufferFromUint16Value(pConnectionRequestFromPawrParameters->connLatency, *ppBuffer);
    fsciBleGetBufferFromUint16Value(pConnectionRequestFromPawrParameters->supervisionTimeout, *ppBuffer);
    fsciBleGetBufferFromUint16Value(pConnectionRequestFromPawrParameters->connEventLengthMin, *ppBuffer);
    fsciBleGetBufferFromUint16Value(pConnectionRequestFromPawrParameters->connEventLengthMax, *ppBuffer);
    fsciBleGetBufferFromBoolValue(pConnectionRequestFromPawrParameters->usePeerIdentityAddress, *ppBuffer);
    fsciBleGetBufferFromEnumValue(pConnectionRequestFromPawrParameters->initiatingPHYs, *ppBuffer, gapLePhyFlags_t);
    fsciBleGetBufferFromUint8Value(pConnectionRequestFromPawrParameters->advHandle, *ppBuffer);
    fsciBleGetBufferFromUint8Value(pConnectionRequestFromPawrParameters->subevent, *ppBuffer);
}
...
void fsciBleGapGetPeriodicScannedDeviceV2FromBuffer(gapPeriodicScannedDeviceV2_t* pScannedDevice, uint8_t** ppBuffer)
{
    ...
    fsciBleGetUint8ValueFromBufferSigned(pScannedDevice->rssi, *ppBuffer);
    fsciBleGetUint8ValueFromBufferSigned(pScannedDevice->txPower, *ppBuffer);
    fsciBleGetUint8ValueFromBuffer(pScannedDevice->cteType, *ppBuffer);
    fsciBleGetUint16ValueFromBuffer(pScannedDevice->periodicEventCounter, *ppBuffer);
    fsciBleGetUint8ValueFromBuffer(pScannedDevice->subevent, *ppBuffer);
    fsciBleGetUint16ValueFromBuffer(pScannedDevice->dataLength, *ppBuffer);
    fsciBleGetArrayFromBuffer(pScannedDevice->pData, *ppBuffer, pScannedDevice->dataLength);
}

void fsciBleGapGetBufferFromPerScannedDeviceV2(gapPeriodicScannedDeviceV2_t* pScannedDevice, uint8_t** ppBuffer)
{
    /* Write gapPeriodicScannedDeviceV2_t fields in buffer */
    fsciBleGetBufferFromUint16Value(pScannedDevice->syncHandle, *ppBuffer);
    fsciBleGetBufferFromUint8ValueSigned(pScannedDevice->rssi, *ppBuffer);
    fsciBleGetBufferFromUint8ValueSigned(pScannedDevice->txPower, *ppBuffer);
    fsciBleGetBufferFromUint8Value(pScannedDevice->cteType, *ppBuffer);
    fsciBleGetBufferFromUint16Value(pScannedDevice->periodicEventCounter, *ppBuffer);
    fsciBleGetBufferFromUint8Value(pScannedDevice->subevent, *ppBuffer);
    fsciBleGetBufferFromUint16Value(pScannedDevice->dataLength, *ppBuffer);
    fsciBleGetBufferFromArray(pScannedDevice->pData, *ppBuffer, pScannedDevice->dataLength);
}
#endif /* (defined gBLE54_PawrSupport_d) && (gBLE54_PawrSupport_d == TRUE) */
...
void fsciBleGapGetBufferFromPeriodicAdvSyncTransferReceived(gapSyncTransferReceivedEventData_t* pSyncTransferReceived, uint8_t** ppBuffer)
{
    ...
    fsciBleGetBufferFromUint8Value(pSyncTransferReceived->numSubevents, *ppBuffer);
    fsciBleGetBufferFromUint8Value(pSyncTransferReceived->subeventInterval, *ppBuffer);
    fsciBleGetBufferFromUint8Value(pSyncTransferReceived->responseSlotDelay, *ppBuffer);
    fsciBleGetBufferFromUint8Value(pSyncTransferReceived->responseSlotSpacing, *ppBuffer);
}
#endif  /* gBLE51_d */
...
void fsciBleGapGetConnectedEventFromBuffer(gapConnectedEvent_t* pConnectedEvent, uint8_t** ppBuffer)
{
    ...
    fsciBleGetUint8ValueFromBuffer(pConnectedEvent->advHandle, *ppBuffer);
    fsciBleGetUint16ValueFromBuffer(pConnectedEvent->syncHandle, *ppBuffer);
}
...
void fsciBleGapGetBufferFromConnectedEvent(gapConnectedEvent_t* pConnectedEvent, uint8_t** ppBuffer)
{
    ...
    fsciBleGetBufferFromUint8Value(pConnectedEvent->advHandle, *ppBuffer);
    fsciBleGetBufferFromUint16Value(pConnectedEvent->syncHandle, *ppBuffer);
}
...
uint32_t fsciBleGapGetAdvertisingEventBufferSize(gapAdvertisingEvent_t* pAdvertisingEvent)
{
    ...
    switch(pAdvertisingEvent->eventType)
    {
        ...
        case gPerAdvSubeventDataRequest_c:
            {
                bufferSize += sizeof(uint8_t);          /* handle */
                bufferSize += sizeof(uint8_t);          /* subeventStart */
                bufferSize += sizeof(uint8_t);          /* subeventDataCount */
            }
            break;
        ...
        case gPerAdvResponse_c:
            {
                ...
                bufferSize += sizeof(uint8_t);          /* subevent */
                bufferSize += sizeof(uint8_t);          /* txPower */
                bufferSize += sizeof(uint8_t);          /* rssi */
                bufferSize += sizeof(uint8_t);          /* cteType */
                bufferSize += sizeof(uint8_t);          /* responseSlot */
                bufferSize += sizeof(uint8_t);          /* dataLength */
                bufferSize += pAdvertisingEvent->eventData.perAdvResponse.dataLength;   /* aData */
            }
            break;
#endif /* (defined gBLE54_PawrSupport_d) && (gBLE54_PawrSupport_d == TRUE) */
#endif
...
void fsciBleGapGetAdvertisingEventFromBuffer(gapAdvertisingEvent_t* pAdvertisingEvent, uint8_t** ppBuffer)
{
    ...
    switch(pAdvertisingEvent->eventType)
    {
        ...
        case gPerAdvSubeventDataRequest_c:
            {
                fsciBleGetUint8ValueFromBuffer(pAdvertisingEvent->eventData.subeventDataRequest.handle, *ppBuffer);
                fsciBleGetUint8ValueFromBuffer(pAdvertisingEvent->eventData.subeventDataRequest.subeventStart, *ppBuffer);
                fsciBleGetUint8ValueFromBuffer(pAdvertisingEvent->eventData.subeventDataRequest.subeventDataCount, *ppBuffer);
            }
            break;
        case gPerAdvResponse_c:
            {
                fsciBleGetUint8ValueFromBuffer(pAdvertisingEvent->eventData.perAdvResponse.advHandle, *ppBuffer);
                fsciBleGetUint8ValueFromBuffer(pAdvertisingEvent->eventData.perAdvResponse.subevent, *ppBuffer);
                fsciBleGetUint8ValueFromBuffer(pAdvertisingEvent->eventData.perAdvResponse.txPower, *ppBuffer);
                fsciBleGetUint8ValueFromBuffer(pAdvertisingEvent->eventData.perAdvResponse.rssi, *ppBuffer);
                fsciBleGetUint8ValueFromBuffer(pAdvertisingEvent->eventData.perAdvResponse.cteType, *ppBuffer);
                fsciBleGetUint8ValueFromBuffer(pAdvertisingEvent->eventData.perAdvResponse.responseSlot, *ppBuffer);
                fsciBleGetUint8ValueFromBuffer(pAdvertisingEvent->eventData.perAdvResponse.dataLength, *ppBuffer);
                fsciBleGetArrayFromBuffer(pAdvertisingEvent->eventData.perAdvResponse.aData, *ppBuffer, 
                                          pAdvertisingEvent->eventData.perAdvResponse.dataLength);
            }
            break;
#endif /* (defined gBLE54_PawrSupport_d) && (gBLE54_PawrSupport_d == TRUE) */
#endif
...
void fsciBleGapGetBuffFromAdvEvent(gapAdvertisingEvent_t* pAdvertisingEvent, uint8_t** ppBuffer)
{
    ...
    switch(pAdvertisingEvent->eventType)
    {
        ...
        case gPerAdvSubeventDataRequest_c:
            {
                fsciBleGetBufferFromUint8Value(pAdvertisingEvent->eventData.subeventDataRequest.handle, *ppBuffer);
                fsciBleGetBufferFromUint8Value(pAdvertisingEvent->eventData.subeventDataRequest.subeventStart, *ppBuffer);
                fsciBleGetBufferFromUint8Value(pAdvertisingEvent->eventData.subeventDataRequest.subeventDataCount, *ppBuffer);
            }
            break;
        case gPerAdvResponse_c:
            {
                fsciBleGetBufferFromUint8Value(pAdvertisingEvent->eventData.perAdvResponse.advHandle, *ppBuffer);
                fsciBleGetBufferFromUint8Value(pAdvertisingEvent->eventData.perAdvResponse.subevent, *ppBuffer);
                fsciBleGetBufferFromUint8Value(pAdvertisingEvent->eventData.perAdvResponse.txPower, *ppBuffer);
                fsciBleGetBufferFromUint8Value(pAdvertisingEvent->eventData.perAdvResponse.rssi, *ppBuffer);
                fsciBleGetBufferFromUint8Value(pAdvertisingEvent->eventData.perAdvResponse.cteType, *ppBuffer);
                fsciBleGetBufferFromUint8Value(pAdvertisingEvent->eventData.perAdvResponse.responseSlot, *ppBuffer);
                fsciBleGetBufferFromUint8Value(pAdvertisingEvent->eventData.perAdvResponse.dataLength, *ppBuffer);
                fsciBleGetBufferFromArray(pAdvertisingEvent->eventData.perAdvResponse.aData, *ppBuffer,
                                          pAdvertisingEvent->eventData.perAdvResponse.dataLength);
            }
            break;
#endif /* (defined gBLE54_PawrSupport_d) && (gBLE54_PawrSupport_d == TRUE) */
        ...
        case gPeriodicAdvSyncEstablished_c:
            {
                ...
                bufferSize += sizeof(uint8_t);                          /* Num Subevents */
                bufferSize += sizeof(uint8_t);                          /* Subevent Interval */
                bufferSize += sizeof(uint8_t);                          /* Response Slot Delay */
                bufferSize += sizeof(uint8_t);                          /* Response Slot Spacing */
            }
            break;
        ...
        case gPeriodicAdvSyncEstablished_c:
            {
                ...
                fsciBleGetBufferFromUint8Value(pScanningEvent->eventData.syncEstb.numSubevents, *ppBuffer);
                fsciBleGetBufferFromUint8Value(pScanningEvent->eventData.syncEstb.subeventInterval, *ppBuffer);
                fsciBleGetBufferFromUint8Value(pScanningEvent->eventData.syncEstb.responseSlotDelay, *ppBuffer);
                fsciBleGetBufferFromUint8Value(pScanningEvent->eventData.syncEstb.responseSlotSpacing, *ppBuffer);
            }
            break;
...
#if (defined gBLE54_PawrSupport_d) && (gBLE54_PawrSupport_d == TRUE)
void fsciBleGapGetPeriodicAdvParametersV2FromBuffer(gapPeriodicAdvParametersV2_t* pAdvertisingParameters, uint8_t** ppBuffer)
{
    /* Read gapPeriodicAdvParametersV2_t fields from buffer */
    fsciBleGetUint8ValueFromBuffer( pAdvertisingParameters->handle,             *ppBuffer);
    fsciBleGetUint16ValueFromBuffer(pAdvertisingParameters->minInterval,        *ppBuffer);
    fsciBleGetUint16ValueFromBuffer(pAdvertisingParameters->maxInterval,        *ppBuffer);

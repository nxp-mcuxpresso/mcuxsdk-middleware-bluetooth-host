...
static const int16_t maConnectionEventToOpcode[]=
{
    ...
    (int16_t)gBleGapEvtConnectionEventRemoteFeaturesRead_c,                        /* 0X32U, gConnEvtRemoteFeaturesRead_c */
};
...
static const int16_t maGenericEvent2ToOpcode[]= {
    ...
    -1,                                                                                      /* reserved: 0x4AU */
    (int16_t)gBleGapChannelOverrideComplete_c,                                                        /* = 0x4B, gLeChannelOverrideComplete_c */
#if (defined gBLE54_PawrSupport_d) && (gBLE54_PawrSupport_d == TRUE)
    (int16_t)gBleGapEvtGenericEventPeriodicAdvSetSubeventDataCompleteOpCode_c,               /* = 0x4BU, gPeriodicAdvSetSubeventDataComplete_c */
    (int16_t)gBleGapEvtGenericEventPeriodicAdvSetResponseDataCompleteOpCode_c,               /* = 0x4CU, gPeriodicAdvSetResponseDataComplete_c */
    (int16_t)gBleGapEvtGenericEventPeriodicSyncSubeventCompleteOpCode_c,                     /* = 0x4DU, gPeriodicSyncSubeventComplete_c */
    ...
    -1,                                                                                      /* reserved: 0x5AU */
     ...
     (int16_t)gBleGapEvtGenericEventLeModulationTestComplete_c,                              /* = 0x5CU, gLeModulationTestComplete_c */
};


/* GAP callbacks structure initialized with FSCI empty static functions */
fsciBleGapCallbacks_t fsciBleGapCallbacks =
{

...
/*! *********************************************************************************
* \brief  Places LL Pending Data parameters update event parameters into a buffer.
*
* \param[in]       pHandoverLlPendingDataEventParams  Pointer to the params structure.
* \param[in,out]   ppBuffer                             Double pointer to the buffer.
*
********************************************************************************** */
